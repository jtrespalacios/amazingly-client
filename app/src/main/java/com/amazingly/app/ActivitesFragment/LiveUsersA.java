...
import com.amazingly.app.ActivitesFragment.LiveStreaming.LiveUserAdapter;
import com.amazingly.app.ActivitesFragment.LiveStreaming.LiveUserModel;
import com.amazingly.app.ActivitesFragment.LiveStreaming.activities.LiveActivity;
...
import com.amazingly.app.SimpleClasses.TicTic;
...
public class LiveUsersA extends AppCompatLocaleActivity implements View.OnClickListener {
    ...
    public void openTicTicLive(String userId, String userName, String userImage, int role) {
        ...
        intent.putExtra(com.amazingly.app.ActivitesFragment.LiveStreaming.Constants.KEY_CLIENT_ROLE, role);
