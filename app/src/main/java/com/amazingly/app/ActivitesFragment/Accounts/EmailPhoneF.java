        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0:
                        text_history.setTextColor(ContextCompat.getColor(view.getContext(),R.color.colorPrimary));
                        break;
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0:
                        text_history.setTextColor(ContextCompat.getColor(view.getContext(),R.color.black));
                        break;
                    case 1:
                        text_history.setTextColor(ContextCompat.getColor(view.getContext(),R.color.black));
                        break;
