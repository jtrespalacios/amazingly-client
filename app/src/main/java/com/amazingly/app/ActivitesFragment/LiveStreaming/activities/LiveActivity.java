package com.amazingly.app.ActivitesFragment.LiveStreaming.activities;
...
import com.amazingly.app.ActivitesFragment.LiveStreaming.LiveCommentModel;
import com.amazingly.app.ActivitesFragment.LiveStreaming.LiveCommentsAdapter;
import com.amazingly.app.ActivitesFragment.LiveStreaming.LiveUserModel;
import com.amazingly.app.ActivitesFragment.LiveStreaming.LiveUserViewAdapter;
import com.amazingly.app.ActivitesFragment.LiveStreaming.stats.LocalStatsData;
import com.amazingly.app.ActivitesFragment.LiveStreaming.stats.RemoteStatsData;
import com.amazingly.app.ActivitesFragment.LiveStreaming.stats.StatsData;
import com.amazingly.app.ActivitesFragment.LiveStreaming.ui.VideoGridContainer;
import com.amazingly.app.ActivitesFragment.SendGift.StickerGiftF;
import com.amazingly.app.ActivitesFragment.SendGift.StickerModel;
import com.amazingly.app.ApiClasses.ApiLinks;
import com.amazingly.app.Models.StreamShowHeartModel;
import com.amazingly.app.Models.UserOnlineModel;
import com.amazingly.app.SimpleClasses.OnSwipeTouchListener;
import com.amazingly.app.SimpleClasses.StreamingLikes.HeartView;
import com.volley.plus.VPackages.VolleyRequest;
import com.amazingly.app.Interfaces.AdapterClickListener;
import com.amazingly.app.Interfaces.FragmentCallBack;
...
public class LiveActivity extends RtcBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(com.amazingly.app.Constants.STREAMING_LIMIT)
        {
            try {
               if (userRole == Constants.CLIENT_ROLE_BROADCASTER)
               {
                   ...
                   },com.amazingly.app.Constants.MAX_STREMING_TIME);
               }
            }
            catch (Exception e)
            {
                Log.d(com.amazingly.app.Constants.tag,"Exception streaming : "+e);
            }
        }
    }
        ...
        joinValueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists())
                {
                    ...
                    {
                        Log.d(com.amazingly.app.Constants.tag,"Data JSON : "+joinSnapsot.getValue().toString());
    ...
    private void initUI() {
        ...
        Functions.printLog(com.amazingly.app.Constants.tag, "initUI");
        ...
        rtcEngine().setBeautyEffectOptions(isbeautyActivated,
                com.amazingly.app.ActivitesFragment.LiveStreaming.Constants.DEFAULT_BEAUTY_OPTIONS);
    ...
    private void initUserIcon() {
        Functions.printLog(com.amazingly.app.Constants.tag, "initUserIcon");
    ...
    private void initData() {
        Functions.printLog(com.amazingly.app.Constants.tag, "initData");
        mVideoDimension = com.amazingly.app.ActivitesFragment.LiveStreaming.Constants.VIDEO_DIMENSIONS[
    ...
    public void onFirstRemoteVideoDecoded(final int uid, int width, int height, int elapsed) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Functions.printLog(com.amazingly.app.Constants.tag, "onFirstRemoteVideoDecoded");
    ...
    private void renderRemoteUser(int uid) {
        Functions.printLog(com.amazingly.app.Constants.tag, "renderRemoteUser");
    ...
    public void onRtcStats(IRtcEngineEventHandler.RtcStats stats) {
        Functions.printLog(com.amazingly.app.Constants.tag, "onRtcStats");
        if (!statsManager().isEnabled()) return;
    ...
    public void onNetworkQuality(int uid, int txQuality, int rxQuality) {
        Functions.printLog(com.amazingly.app.Constants.tag, "onNetworkQuality");
        if (!statsManager().isEnabled()) return;
    ...
    public void onRemoteVideoStats(IRtcEngineEventHandler.RemoteVideoStats stats) {
        Functions.printLog(com.amazingly.app.Constants.tag, "onRemoteVideoStats");
        if (!statsManager().isEnabled()) return;
    ...
    public void onRemoteAudioStats(IRtcEngineEventHandler.RemoteAudioStats stats) {
        Functions.printLog(com.amazingly.app.Constants.tag, "onRemoteAudioStats");
        if (!statsManager().isEnabled()) return;
        ...
        if (streamerConnectCheckListener ==null)
        {
            ...
            streamerConnectCheckListener =new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (connected) {
                        Log.d(com.amazingly.app.Constants.tag, "connected");
                        streamerTimer.cancel();
                    } else {
                        Log.d(com.amazingly.app.Constants.tag, "not connected");
                        streamerTimer.cancel();
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Log.w(com.amazingly.app.Constants.tag, "Listener was cancelled");
                }
            };
