...
public class VideoRecoderDuetA extends AppCompatLocaleActivity implements View.OnClickListener {
    ...
    public void startOrStopRecording() {
        ...
        if (!isRecording && secPassed < (Constants.RECORDING_DURATION / 1000) - 1) {
            ...
            recordImage.setImageDrawable(ContextCompat.getDrawable(VideoRecoderDuetA.this,R.drawable.ic_recoding_yes));
            ...
            recordImage.setImageDrawable(ContextCompat.getDrawable(VideoRecoderDuetA.this,R.drawable.ic_recoding_no));
        ...
        switch (v.getId()) {
            ...
            case R.id.flash_camera:
                ...
                if (isFlashOn) {
                    ...
                    flashBtn.setImageDrawable(ContextCompat.getDrawable(VideoRecoderDuetA.this,R.drawable.ic_flash_on));
                } else {
                    isFlashOn = true;
                    cameraView.setFlash(CameraKit.Constants.FLASH_TORCH);
                    flashBtn.setImageDrawable(ContextCompat.getDrawable(VideoRecoderDuetA.this,R.drawable.ic_flash_off));
                }
