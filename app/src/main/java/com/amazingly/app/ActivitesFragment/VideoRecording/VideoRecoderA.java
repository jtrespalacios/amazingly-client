package com.amazingly.app.ActivitesFragment.VideoRecording;
...
import com.amazingly.app.Interfaces.ProgressBarListener;
import com.amazingly.app.SimpleClasses.SegmentedProgressBar;
...
import com.amazingly.app.ActivitesFragment.SoundLists.SoundListMainA;
import com.googlecode.mp4parser.authoring.Movie;
import com.googlecode.mp4parser.authoring.Track;
import com.googlecode.mp4parser.authoring.builder.DefaultMp4Builder;
import com.googlecode.mp4parser.authoring.container.mp4.MovieCreator;
import com.googlecode.mp4parser.authoring.tracks.AppendTrack;
import com.amazingly.app.TrimModule.TrimType;
import com.amazingly.app.TrimModule.TrimVideo;
import com.amazingly.app.TrimModule.TrimmerUtils;
...
public class VideoRecoderA extends AppCompatLocaleActivity implements View.OnClickListener {
    ...
    public void startOrStopRecording() {
        ...
        if (!isRecording && secPassed < (Constants.RECORDING_DURATION / 1000) - 1) {
            ...
            doneBtn.setImageDrawable(ContextCompat.getDrawable(VideoRecoderA.this,R.drawable.ic_not_done));
            doneBtn.setEnabled(false);

            videoProgress.resume();


            recordImage.setImageDrawable(ContextCompat.getDrawable(VideoRecoderA.this,R.drawable.ic_recoding_yes));
            ...
            recordImage.setImageDrawable(ContextCompat.getDrawable(VideoRecoderA.this,R.drawable.ic_recoding_no));
    ...
    public void checkDoneBtnEnable() {
        if (secPassed > (Constants.MIN_TIME_RECORDING / 1000)) {
            doneBtn.setImageDrawable(ContextCompat.getDrawable(VideoRecoderA.this,R.drawable.ic_done_red));
        ...
        switch (v.getId()) {
            ...
            case R.id.flash_camera:
                ...
                if (isFlashOn) {
                    ...
                    flashBtn.setImageDrawable(ContextCompat.getDrawable(VideoRecoderA.this,R.drawable.ic_flash_on));

                } else {
                    isFlashOn = true;
                    cameraView.setFlash(CameraKit.Constants.FLASH_TORCH);
                    flashBtn.setImageDrawable(ContextCompat.getDrawable(VideoRecoderA.this,R.drawable.ic_flash_off));
                }
            ...
            case R.id.short_video_time_txt:
                ...
                shortVideoTimeTxt.setTextColor(ContextCompat.getColor(VideoRecoderA.this,R.color.white));
                longVideoTimeTxt.setTextColor(ContextCompat.getColor(VideoRecoderA.this,R.color.graycolor2));
            ...
            case R.id.long_video_time_txt:
                ...
                shortVideoTimeTxt.setTextColor(ContextCompat.getColor(VideoRecoderA.this,R.color.graycolor2));
                longVideoTimeTxt.setTextColor(ContextCompat.getColor(VideoRecoderA.this,R.color.white));
