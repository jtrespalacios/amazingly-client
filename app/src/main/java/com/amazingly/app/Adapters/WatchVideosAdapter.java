package com.amazingly.app.Adapters;
    ...
    public void onBindViewHolder(final WatchVideosAdapter.CustomViewHolder holder, final int i) {
        ...
        try {
            ...
            if (item.liked.equals("1")) {
                holder.likeImage.setLikeDrawable(ContextCompat.getDrawable(context,R.drawable.ic_heart_gradient));
                holder.likeImage.setLiked(true);
            } else {
                holder.likeImage.setLikeDrawable(ContextCompat.getDrawable(context,R.drawable.ic_unliked));
