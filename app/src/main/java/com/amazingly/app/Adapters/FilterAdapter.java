...
import com.amazingly.app.SimpleClasses.FilterType;
import com.amazingly.app.R;
import com.amazingly.app.ActivitesFragment.VideoRecording.PreviewVideoA;
...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.CustomViewHolder> {
    ...
    public void onBindViewHolder(final FilterAdapter.CustomViewHolder holder, final int i) {
        ...
        if (PreviewVideoA.selectPostion == i) {
            holder.ivPhoto.setBackgroundColor(ContextCompat.getColor(context,R.color.colorPrimary));
        }
