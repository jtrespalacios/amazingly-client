            ...
            public void onResponce(String resp) {
                ...
                try {
                    ...
                    if (code.equals("200")) {
                        ...
                        if (userDetailModel.getId().equalsIgnoreCase(Functions.getSharedPreference(MainMenuActivity.this).getString(Variables.U_ID,"")))
                        {
        ...
        if (!mainMenuFragment.onBackPressed()) {
            ...
            if (count == 0) {
                if (mBackPressed + 2000 > System.currentTimeMillis()) {
                    ...
                    if (mainMenuFragment.tabLayout.getSelectedTabPosition()==0)
                    {
                    ...
                    {
                        TabLayout.Tab profile = mainMenuFragment.tabLayout.getTabAt(0);
                        profile.select();
                    }
