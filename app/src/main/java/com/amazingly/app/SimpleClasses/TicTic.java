package com.amazingly.app.SimpleClasses;
...
import com.amazingly.app.ActivitesFragment.CustomErrorActivity;
import com.amazingly.app.ActivitesFragment.LiveStreaming.Constants;
import com.amazingly.app.ActivitesFragment.LiveStreaming.rtc.AgoraEventHandler;
import com.amazingly.app.ActivitesFragment.LiveStreaming.rtc.EngineConfig;
import com.amazingly.app.ActivitesFragment.LiveStreaming.rtc.EventHandler;
import com.amazingly.app.ActivitesFragment.LiveStreaming.stats.StatsManager;
import com.amazingly.app.ActivitesFragment.LiveStreaming.utils.FileUtil;
import com.amazingly.app.ActivitesFragment.LiveStreaming.utils.PrefManager;
import com.amazingly.app.ActivitesFragment.Profile.Setting.NoInternetA;
...
import static com.amazingly.app.SimpleClasses.ImagePipelineConfigUtils.getDefaultImagePipelineConfig;
...
public class TicTic extends Application implements Application.ActivityLifecycleCallbacks, BackgroundDetectorHandler.OnVisibilityChangedListener {
        ...
        if (Functions.getSharedPreference(getApplicationContext()).getBoolean(Variables.IS_LOGIN,false))
        {
            rootref.child(Variables.onlineUser).child(Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0"))
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Log.d(com.amazingly.app.Constants.tag,"removeOnlineStatus: "+Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0"));
                };
            });
        ...
        if (Functions.getSharedPreference(getApplicationContext()).getBoolean(Variables.IS_LOGIN,false))
        {
            ...
            rootref.child(Variables.onlineUser).child(Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0")).setValue(onlineModel)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            Log.d(com.amazingly.app.Constants.tag,"addOnlineStatus: "+onlineModel.getUserId());
                        };
                    });
        ...
        FirebaseMessaging.getInstance().getToken()
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        ...
                        Log.d(com.amazingly.app.Constants.tag,"token: "+token);
    ...
    {
        Log.d(com.amazingly.app.Constants.tag,"onAppGoesToBackground");
        removeOnlineListener();
    }
    ...
    {
        Log.d(com.amazingly.app.Constants.tag,"onAppGoesToForeground");
        addOnlineListener();
    }
